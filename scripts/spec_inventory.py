...
REQUIRED_FILES = [
    ...
    "tokenizer/data/t4_smoke_seed.txt",
    "magi/tokenizer/byte_bpe.py",
    "scripts/t4_smoke_run.py",
    "scripts/t4_train_smoke.py",
    "scripts/validate_all_models.py",
    "configs/magi_t4_train_smoke_v0.1.yaml",
    "magi/train/__init__.py",
    "magi/train/loop.py",
    "tests/test_t4_smoke.py",
    "tests/test_t4_train_smoke.py",
